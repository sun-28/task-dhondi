...
const VCard = ({title,name,created_at,content,tags,id,setShowModal,setpostDetails,isYourPosts}) => {
  ...
  return (
    <div onClick={handleOpenPost} className='flex flex-col bg-white m-8 rounded-md h-48 p-4 gap-2'>
        <div className='flex justify-between m-2'>
          <h3 className='flex-2 text-lg font-medium'>{title}</h3>
          {isYourPosts && <div className='flex gap-4 items-center justify-center'>
            <svg onClick={()=>{
            ...
            <svg onClick={handleDelete} width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <hr/>
        <p className='flex flex-1'>{content} Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam alias incidunt numquam ipsam similique, eius eveniet cumque ullam nulla beatae est totam ad maiores fugiat. Laborum voluptatem rem eum voluptas?</p>
