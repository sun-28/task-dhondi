  ...
  return (
    <div className='flex w-full'>
      ...
      <svg onClick={() => window.history.back()} width="30" height="30" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12.6707 14.8447L8.32584 10.4999L12.6707 6.15503" stroke="black" stroke-opacity="0.63" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      </div>
    <div className='flex flex-col p-4 gap-2 w-full'>
        <div className='flex justify-between m-2'>
          ...
          { yourPosts && <div className='flex gap-4 items-center justify-center'>
            ...
            <path d="M7.12221 22.7853L5.69794 28.4824L11.395 27.0581L27.8966 10.5565C28.4307 10.0224 28.7306 9.29795 28.7306 8.54262C28.7306 7.78729 28.4307 7.06288 27.8966 6.5287L27.6517 6.28372C27.1175 5.7497 26.3931 5.44971 25.6377 5.44971C24.8824 5.44971 24.158 5.7497 23.6238 6.28372L7.12221 22.7853Z" stroke="black" stroke-width="2.84854" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M21.363 8.54272L25.6358 12.8155M18.5145 28.4825H29.9086" stroke="black" stroke-width="2.84854" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <svg onClick={()=>{
              setshowDel(true)
            }} width="30" height="30" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
