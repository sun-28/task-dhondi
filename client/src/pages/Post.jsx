...
const Post = () => {
  ...
  return (
    <div className='flex flex-col p-4 gap-2'>
        ...
        <hr/>
        <p className='flex flex-1'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam alias incidunt numquam ipsam similique, eius eveniet cumque ullam nulla beatae est totam ad maiores fugiat. Laborum voluptatem rem eum voluptas?</p>
